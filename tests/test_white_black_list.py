...
class TestWhiteBlackList(unittest.TestCase):
    def test_check_success(self):
        layer = SimpleLayer()
        layer.eval()
        white_list_layers = [layer.linear1, layer.linear2]
        black_list_layers = [layer.linear1]
        ...
        module = SimpleModule()
        module.eval()
        white_list_layers = [module.linear1, module.linear2]
        module = create_model(module, "module")
        module.update_white_list(white_list_layers, "all")
