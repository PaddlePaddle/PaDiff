...
class TestCaseName(unittest.TestCase):
    def test_weight_grad_check(self):
        ...
        weight_check = check_weight((create_proxy_model(layer), create_proxy_model(module)), options, LayerMap())
        grad_check = check_grad((create_proxy_model(layer), create_proxy_model(module)), options, LayerMap())
